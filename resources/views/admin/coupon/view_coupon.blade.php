            ...
            <div class="row">
                                    ...
                                    <tbody>
                                        @foreach($coupons as $item)
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    <a href="{{ route('wpadmin.coupons.edit',$item->id) }}" class="btn btn-info" title="Edit Data">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="{{ route('wpadmin.coupons.delete',$item->id) }}" class="btn btn-danger" title="Delete Data" id="delete">
                ...
                <div class="col-4">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('wpadmin.coupons.store') }}" >
                                    @csrf
