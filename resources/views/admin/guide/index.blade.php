    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Guides Page ( {{ $guides->total() }} )</h4>
                        <div class="template-demo">
                            <a href="{{ route('wpadmin.guides.add') }}">
                                <button type="button" class="btn btn-primary btn-fw">Add New Guide</button>
                            </a>
                        </div>
