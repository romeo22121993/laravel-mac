                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach( $products as $item)
                                            <tr>
                                                <td><img src="{{ asset( $item->thumbnail ) }}" style="width: 60px; height: 50px;">  </td>
                                                <td>{{ $item->name }}</td>
                                                ...
                                                <td width="30%">
                                                    ...
                                                    @if( $item->status == 1 )
                                                        <a href="{{ route('wpadmin.products.inactive', $item->id) }}" class="btn btn-danger" title="Inactive Now"><i class="fa fa-arrow-down"></i> </a>
                                                    @else
                                                        <a href="{{ route('wpadmin.products.active', $item->id) }}" class="btn btn-success" title="Active Now"><i class="fa fa-arrow-up"></i> </a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
