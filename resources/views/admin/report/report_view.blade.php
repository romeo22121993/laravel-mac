            ...
            <div class="row">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('wpadmin.reports.search-by-date') }}">
                                    @csrf
                ...
                <div class="col-4">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('wpadmin.reports.search-by-month') }}">
                                    @csrf
                ...
                <div class="col-4">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('wpadmin.reports.search-by-year') }}" >
                                    @csrf
