            ...
            <div class="row">
                <div class="col">
                    <div class="home_content">
                        ...
                        <div class="video-holder video-holder-home" style="background: url( {{ asset('frontendDashboard/themesAssets/dist/img/Group-72-min.png') }});"><a></a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center justify-content-sm-start justify-content-lg-center">
                <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                    <div class="sv-social-proof__img">
                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/Bitmap.png') }}"
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                    <div class="sv-social-proof__img">
                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/header-logo-2.png') }}"
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                    <div class="sv-social-proof__img">
                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/Think-Advisor-Logo.png') }}"
                             alt="Think Advisor"
                             class=""
                        >
                    </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                    <div class="sv-social-proof__img">
                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/XY_Planning_Network_Logo-transparent-1.png') }}"
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-2">
                    <div class="sv-social-proof__img">
                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/Kitcescom-1.png') }}"
                             alt="Kitcescom-1"
                             class="last"
                        >
                    </div>
    ...
    <div class="default-padding our-philosophy">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontendDashboard/themesAssets/dist/img/timley_topics.png') }}" alt=""/>
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontendDashboard/themesAssets/dist/img/icon_care.svg') }}" alt=""/>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontendDashboard/themesAssets/dist/img/icon_build-1.svg') }}" alt=""/>
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('frontendDashboard/themesAssets/dist/img/icon_practice.svg') }}" alt=""/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="http://seven.loc/about/">See More <img src="{{ asset('frontendDashboard/themesAssets/dist/img/arrow-right.png') }}" alt="arrow right"/></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <a href=" http://seven.loc/contact/" class="read-more">
                        LEARN MORE <img src="{{ asset('frontendDashboard/themesAssets/dist/img/arrow-right.png') }}" alt="arrow right"/>
                    </a>
                </div>
