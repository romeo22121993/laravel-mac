        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-4 one-program-card">
                    <img src="{{ asset('frontendDashboard/themesAssets/dist/img/icon_launchpad_alt.png') }}" alt=""/>
                    <h4></h4>
                ...
                <div class="col-lg-4 one-program-card">
                    <img src="{{ asset('frontendDashboard/themesAssets/dist/img/icon_build.svg') }}" alt=""/>
                    <h4></h4>
                ...
                <div class="col-lg-4 one-program-card">
                    <img src="{{ asset('frontendDashboard/themesAssets/dist/img/icon_runway_alt.png') }}" alt=""/>
                    <h4></h4>
                    ...
                    <div class="box full mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-lg-6 text-left">
                                <div class="row">
                                    <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/timley_topics.png') }}" alt="p-img-1"/>
                                    </div>
                            ...
                            <div class="col-xs-12 col-lg-6 text-left">
                                <div class="row">
                                    <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/written.png') }}" alt="p-img-1"/>
                                    </div>
                                    <div class="col-lg-9 d-flex justify-content-center align-items-start flex-column">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-lg-6 text-left">
                                <div class="row">
                                    <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/finra.png') }}" alt="p-img-1"/>
                                    </div>
                                    <div class="col-lg-9 d-flex justify-content-center align-items-start flex-column">
                                        <h5>Ready-to-Send</h5>
                            ...
                            <div class="col-xs-12 col-lg-6 text-left">
                                <div class="row">
                                    <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                        <img src="{{ asset('frontendDashboard/themesAssets/dist/img/custom.png') }}" alt="p-img-1"/>
                                    </div>
                                    <div class="col-lg-9 d-flex justify-content-center align-items-start flex-column">
                                        <h5>Customizable</h5>
            ...
            <div class="box full mb-5">
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-6 text-left">
                        <div class="row">
                            <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                <img src="{{ asset('frontendDashboard/themesAssets/dist/img/digital.png') }}" alt="http://seven.loc/wp-content/uploads/2019/11/digital.png"/>
                            </div>
                            <div class="col-lg-9 d-flex justify-content-center align-items-start flex-column">
                    ...
                    <div class="col-xs-12 col-lg-6 text-left">
                        <div class="row">
                            <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                <img src="{{ asset('frontendDashboard/themesAssets/dist/img/action.png') }}" alt="http://seven.loc/wp-content/uploads/2019/11/action.png"/>
                            </div>
                            <div class="col-lg-9 d-flex justify-content-center align-items-start flex-column">
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-6 text-left">
                        <div class="row">
                            <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                <img src="{{ asset('frontendDashboard/themesAssets/dist/img/digest.png') }}" alt="http://seven.loc/wp-content/uploads/2019/11/digest.png"/>
                            </div>
                            <div class="col-lg-9 d-flex justify-content-center align-items-start flex-column">
                                <h5>Digital-First</h5>
                    ...
                    <div class="col-xs-12 col-lg-6 text-left">
                        <div class="row">
                            <div class="col-lg-3 d-flex justify-content-center align-items-start flex-row">
                                <img src="{{ asset('frontendDashboard/themesAssets/dist/img/custom.png') }}" alt="http://seven.loc/wp-content/uploads/2019/11/custom.png"/>
                            </div>
                            <div class="col-lg-9 d-flex justify-content-center align-items-start flex-column">
                                <h5>Topical</h5>
        ...
        <div class="container">
            ...
            <div id="slider" class="owl-carousel">
                ...
                <div class="item">
                    <div class="row">
                        <div class="col-xs-12 col-lg-7">
                            <img src="{{ asset('frontendDashboard/themesAssets/dist/img/Body-min-2.png') }}" alt="Body-min"/>
                        </div>
                ...
                <div class="item">
                    <div class="row">
                        <div class="col-xs-12 col-lg-7">
                            <img src="{{ asset('frontendDashboard/themesAssets/dist/img/Body-min-1.png') }}" alt="Body-min"/>
                        </div>
                        <div class="col-xs-12 col-lg-5">
                ...
                <div class="item">
                    <div class="row">
                        <div class="col-xs-12 col-lg-7">
                            <img src="{{ asset('frontendDashboard/themesAssets/dist/img/Body-min.png') }}" alt="Body-min"/>
                        </div>
                        <div class="col-xs-12 col-lg-5">
                            <h3>Coaching Lab</h3>
                    ...
                    <div class="sv-slider-pagination">
                        ...
                        <div class="slider-menu__dots">
                            <div class="loc_slider_nav prev">
                                <img src="{{ asset('frontendDashboard/themesAssets/dist/img/arrow-left.svg') }}" alt="arrow left"/>
                            </div>
