$(function () {
    ...
    $(document).ready(function(){
         ...
         */
        /**
         * Ajax getting subcategories
         *
         */
        $(".subsubcategory, .product_add, .edit_product_page").find('select[name="cat_id"]').on('change', function(){
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        $.each(data, function(key, value){
                            $('select[name="subcat_id"]').append('<option value="'+ value.id +'">' + value.name + '</option>');
                        });
                    },
                });
            } else {
